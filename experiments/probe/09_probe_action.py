...
dataset_path = "/training/activations_dataset/hard/0ts_actions_for_probe_{action}_20000_skip0.pt"
    ...
    for layer in range(-1, 3):
        for weight_decay in [5000, 1000, 500, 100, 1]:
            ...
            def update(config: WandbCommandConfig) -> WandbCommandConfig:
                ...
                config.cmd.train_on.dataset_name = f"actions_for_probe_{action}"
                return config
