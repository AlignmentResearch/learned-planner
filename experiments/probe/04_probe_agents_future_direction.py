...
dataset_path = Path("/training/activations_dataset/hard/0ts_agents_future_direction_map_20000_skip5.pt")
...
for layer in range(-1, 3):
    for weight_decay in [5000, 1000, 500, 100, 1]:
        ...
        def update(config: WandbCommandConfig) -> WandbCommandConfig:
            ...
            config.cmd.train_on.dataset_name = "agents_future_direction_map"
            return config
